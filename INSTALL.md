...
Windows shows it for any program without a code signing certificate, which costs several hundred dollars a year. Folio is free and open source, made by one person for educational purposes, mostly for in-person distribution. These realities render the purchase of a code signing certificate pointless at this time.
