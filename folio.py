...
APP_STYLE = {
    ...
    "editor":                 "",
    "select-list":            "",
    "select-list.selected":   "#2a2a2a bg:#e0af68",
...
_LIGHT_STYLE = {
    # Paper and ink, not sepia. The previous palette put every secondary
    # element between 1.9:1 and 3.2:1 against its own background -- hints,
    # status bar, list markers and the empty-list notice were all below
    # what is legible, which is what made the scheme look muddy rather
    # than light. Everything here that is meant to be read clears 4.5:1;
    # the syntax markers sit at ~3.5:1 on purpose, since they are
    # decoration to look past, not text to read.
    "":                       "#26241f bg:#faf8f3",
    "title":                  "#26241f",
    "status":                 "#5c574e bg:#ece8df",
    "hint":                   "#6b665c bg:#faf8f3",
    "hint.sep":               "#b0a999",
    "accent":                 "#8a4f0f",
    "input":                  "bg:#ece8df #26241f",
    "editor":                 "",
    "select-list":            "",
    "select-list.selected":   "#faf8f3 bg:#8a4f0f",
    "select-list.empty":      "#6b665c",
    "preview":                "#5c574e",
    "keybindings-panel":      "bg:#faf8f3",
    "find-panel":             "bg:#faf8f3",
    "form-label":             "#5c574e",
    "dialog":                 "#26241f bg:#faf8f3",
    "dialog.body":            "#26241f bg:#faf8f3",
    "dialog text-area":       "#26241f bg:#ece8df",
    "dialog frame.label":     "#26241f bold",
    "dialog shadow":          "bg:#c3bdae",
    "button":                 "#26241f bg:#e2ddd0",
    "button.focused":         "#faf8f3 bg:#5c574e",
    "label":                  "#26241f",
    "md.heading-marker":      "#b0a999",
    "md.heading":             "bold #8a4f0f",
    "md.list-marker":         "italic #8c8577",
    "md.quote-marker":        "italic #8c8577",
    "md.wikilink":            "#1f52a0",
    "md.frontmatter":         "#8c8577",
    "md.bold":                "bold",
    "md.italic":              "italic",
    "md.code":                "#5f5a4e",
    "md.footnote":            "#b8501a",
    "md.link":                "#1f52a0",
    "spell-error":            "bold #b0271a",
    "find-match":             "bold #8a4f0f",
}
...
_GREEN_STYLE = {
    ...
    "editor":                 "",
    "select-list":            "",
    "select-list.selected":   "#070c07 bg:#2fe02f",
...
_AMBER_STYLE = {
    ...
    "editor":                 "",
    "select-list":            "",
    "select-list.selected":   "#0f0a02 bg:#ffd75e",
